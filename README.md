...
Hi Sir/MaM This is my submission for the Jarnox Fintech Internship assignment. I built a simple dashboard and REST API to fetch and analyze stock market data. I had a lot of fun putting this together and tried to include a few interesting extra features.
